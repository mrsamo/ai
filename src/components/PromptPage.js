...
Культура: #культура
Симптомы: #симптомы
Условия выращивания: #условия_выращивания
...
Класс: #класс
Тема: #тема
Способ объяснения: #способ_решения
Дополнительные примеры: #дополнительные_примеры
...
Количество человек в семье: #количество_человек
Общий доход: #доход
Обязательные траты: #обязательные_траты
...
Особенности участка: #особенности_участка
Тип работ: #тип_работ
...
Возраст и пол: #возраст/#пол
Показатели с отклонениями: #показатели
Тип рекомендаций: #тип_рекомендаций
          ...
          <div className="prompt-page__content">
            ...
            <div className="prompt-page__content">
              ...
              <div className="placeholder-inputs-section">
                <h4>Заполните плейсхолдеры промпта:</h4>
                <p className="placeholder-description">
                  Плейсхолдеры - это параметры в тексте промпта (например, #культура, #симптомы), которые нужно заменить на ваш текст для кастомизации.
                </p>
                <div className="placeholder-inputs-grid">
                  {extractPlaceholders(prompt.content).map((placeholder, index) => (
                    <div key={index} className="placeholder-input-group">
        ...
        <div className="prompt-page__sidebar">
          ...
          <div className="prompt-tags-section">
            ...
            <p className="tags-description">
              Теги - это ключевые слова, описывающие тематику промпта
            </p>
